  ...
  <div class="q-pa-md">
    <div class="q-gutter-y-md">
      <q-card>
        ...
        >
          <q-tab class="text-primary" name="colors_list" icon="mdi-format-list-text" label="رنگ ها"/>
        </q-tabs>
        <q-separator/>

        <q-tab-panels v-model="tab" animated>
          <q-tab-panel name="colors_list">
            ...
            <div class="q-pl-md q-gutter-sm">
              <q-btn color="primary" outline @click="setDialog('create')" icon="mdi-file-plus-outline" label="افزودن رنگ"/>
            </div>
            <div class="q-pa-md">
              <q-table
                :data="data"
              ...
              >
                <template v-slot:body="props">
                  <q-tr :props="props">
                    ...
                    <q-td key="setting">
                      <q-btn @click="EditColor(props.row.id)" style="color: #4facfe" rounded icon="mdi-square-edit-outline" label="ویرایش" size="md" flat
                             dense>
                        <q-tooltip>ویرایش</q-tooltip>
                      </q-btn>
                      |
                      <q-btn @click="DeleteColor(props.row.name , props.row.id)" style="color: red" rounded
...
export default {
  ...
  methods: {
    ...
    DeleteColor (name, id) {
      ...
      this.$q.dialog({
        title: 'هشدار',
        message: 'آیا میخواهید رنگ ' + ' ( ' + name + ' ) ' + 'حذف شود ؟ ',
        ok: {
          push: true,
          label: 'تایید'
        },
        ...
        app.$axios.delete(process.env.api + 'api/admin/products/colors/' + id)
          .then(function () {
            app.showNotif('رنگ مورد نظر با موفقیت حذف شد', 'mdi-checkbox-marked-circle-outline', 'green')
            app.GetAllColors()
          })
          .catch(function () {
    ...
    EditColor (id) {
      ...
      this.$q.loading.show()
      this.$axios.get(process.env.api + 'api/admin/products/colors/' + id + '/')
    ...
    GetAllColors () {
      ...
      this.$axios.get(process.env.api + 'api/admin/products/colors/?page=' + app.paginationPage + '&search=' + app.search)
        .then(function (response) {
